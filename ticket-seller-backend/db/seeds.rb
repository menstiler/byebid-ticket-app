...
Ticket.create(title: 'Shweaky Concert', category: 'Concert', location: 'Madison square gardin', min_price: 10, buy_now: 50, seller_id: nil, time: 'Tuesday, 6 pm', status: true)
Ticket.create(title: 'Spiderman', category: 'Movie', location: 'AMC', min_price: 10, buy_now: 50, seller_id: nil, time: 'Mondsy, 10 pm', status: true)
